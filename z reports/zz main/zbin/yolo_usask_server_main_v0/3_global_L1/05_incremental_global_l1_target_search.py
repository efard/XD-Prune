#!/usr/bin/env python3
"""
deterministic incremental Global L1 parameter-target search
...
- 9 CUSTOM C3k2/C2PSA roots excluded
- 54 protected roots may receive required input-channel updates, but their output channels will not be removed

Each eligible root must retain at least:
    max(4 channels, ceil(50% of its original output channels))

This search saves CSV/JSON plans.
"""
