...
Examples (run from any directory):
    python Pruning_Study/scripts/run_baselines.py --dataset both --check-only
    python Pruning_Study/scripts/run_baselines.py --dataset both --smoke
    python Pruning_Study/scripts/run_baselines.py --dataset snow --full
    python Pruning_Study/scripts/run_baselines.py --dataset gen --full
