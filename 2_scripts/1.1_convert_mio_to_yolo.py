...
This script creates the split:
    11000 total images = 7700 train + 1650 val + 1650 test

if required files, classes, or bounding boxes are invalid,
...
# Write a compact split summary.
# This makes it easy to verify that the generated dataset matches the 7700/1650/1650 setting.
