...
The script runs a manual forward pass through the Ultralytics model graph and measures how long each layer takes.

The input is a fixed random tensor. This measures model-layer compute latency, not dataset accuracy.
"""
