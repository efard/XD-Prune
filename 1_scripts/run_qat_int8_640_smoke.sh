#!/bin/bash
# 1-epoch smoke test for YOLO26n 640x640 INT8 QAT.
# Run this only after entering an allocated GPU node.
...
RUN_NAME="qat_int8_yolo26n_mio_11000_e1_img640_b8_s42_smoke_$(date +%Y%m%d_%H%M%S)"
